            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <?php 
                    if (isset($error['username'])) {
                        echo '<p class="error">' . htmlspecialchars($error['username']) . '</p>';
                    }
                ?>
                ...
                <?php 
                    if (isset($error['email'])) {
                        echo '<p class="error">' . htmlspecialchars($error['email']) . '</p>';
                    }
                ?>
                ...
                <?php 
                    if (isset($error['password'])) {
                        echo '<p class="error">' . htmlspecialchars($error['password']) . '</p>';
                    }
                ?>
                ...
                <?php 
                    if (isset($error['password2'])) {
                        echo '<p class="error">' . htmlspecialchars($error['password2']) . '</p>';
                    }
                ?>
